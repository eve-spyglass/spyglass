...
class TrayIcon(QtWidgets.QSystemTrayIcon):
    ...
    def showNotification(self, message, system, char, distance):
        ...
        if (
            ...
            title = "ALARM!"
            icon = 2
            speechText = "{0} alarmed in {1}, {2} jumps from {3}".format(
            ...
            icon = 1
            text = "Someone is requesting status of {0} in {1}.".format(system, room)
